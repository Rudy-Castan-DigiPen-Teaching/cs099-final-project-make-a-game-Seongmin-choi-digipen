...
function draw()
{
    ...
    switch(screen){
        ...
        case 3:
            ...
            {
            let d = dist(snowprincess.Shoot[i].position.x, snowprincess.Shoot[i].position.y, blueDwarf.position.x + 40, blueDwarf.position.y + 35);
            ...
            {
            let d = dist(blueDwarf.particle1[i].position.x, blueDwarf.particle1[i].position.y, snowprincess.position.x, snowprincess.position.y);
            ...
            {
            let d = dist(redDwarf.particle[i].position.x, redDwarf.particle[i].position.y, snowprincess.position.x, snowprincess.position.y);
            ...
            {
            let d = dist(redDwarf.particle1[i].position.x, redDwarf.particle1[i].position.y, snowprincess.position.x, snowprincess.position.y);
        ...
        case 4:
            ...
            push()
            fill(255, 0, 0);
            rect(100, 50, 400 * (dwarfPhase.dwarfHp/5000), 10);
            pop()
            for ( let i = 0; i < snowprincess.Shoot.length; i++ )
        {
            let d = dist(snowprincess.Shoot[i].position.x, snowprincess.Shoot[i].position.y, dwarfPhase.position.x + 40, dwarfPhase.position.y + 35);
        ...
        {
            let d = dist(dwarfPhase.particle[i].position.x, dwarfPhase.particle[i].position.y, snowprincess.position.x, snowprincess.position.y);
        ...
        {
            let d = dist(dwarfPhase.particle1[i].position.x, dwarfPhase.particle1[i].position.y, snowprincess.position.x, snowprincess.position.y);
        ...
        {
            let d = dist(dwarfPhase.particle2[i].position.x, dwarfPhase.particle2[i].position.y, snowprincess.position.x, snowprincess.position.y);
